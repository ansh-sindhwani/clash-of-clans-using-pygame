        ...
        if(self.health == 0):
            ...
            for i in range(board.rows):
                for j in range(board.cols):
                    if(board.board[i][j] == 3 or board.board[i][j] == 8):
            ...
            if(xdestination==0 and ydestination == 0):
                ...
                if(xdestination != self.xpos):
                    ...
                    if(xdestination < self.xpos):
                        # upar jana hai
                        # just upar kuch object hai
                        if(board.board[self.xpos-1][self.ypos] == 3 or board.board[self.xpos-1][self.ypos] == 8):
                            if(self.xpos-1 == xdestination and self.ypos == ydestination):
                                if(building == 3):
                                    temp = [x for x in board.cannon if x.xpos ==
                                        self.xpos-1 and x.ypos == self.ypos]
                        ...
                        # just upar kuch nahi hai to thoda bahut move to karenge
                            ...
                            possible = True
                            if(self.xpos - self.step <= xdestination):
                                if(self.ypos == ydestination):
                                    self.xpos = xdestination + 1
                                else:
                                    self.xpos = xdestination 
                                possible = False
                            if(possible):
                                self.xpos = self.xpos - self.step
                    else:
                    ...
                    if(ydestination < self.ypos):
                        # left jana hai
                        # just upar kuch object hai
                        if(board.board[self.xpos][self.ypos-1] == 3 or board.board[self.xpos][self.ypos-1] == 8):
                            if(self.xpos == xdestination and self.ypos-1 == ydestination):
                                if(building == 3):
                                    temp = [x for x in board.cannon if x.xpos ==
                                        self.xpos and x.ypos == self.ypos-1]
